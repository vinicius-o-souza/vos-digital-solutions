...
vos_base theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of vos_base theme and run the following commands:
`nvm use`
...
`drush en vos_base -y`
`drush config-set system.theme default vos_base -y`
