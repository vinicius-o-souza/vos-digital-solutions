...
vos_digital_solutions theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of vos_digital_solutions theme and run the following commands:
`nvm use`
...
`drush en vos_digital_solutions -y`
`drush config-set system.theme default vos_digital_solutions -y`
